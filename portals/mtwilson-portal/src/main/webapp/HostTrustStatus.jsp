...
<div class="container">
			...
			<a id="refresh_all" href="#" onclick="fnGetUpdateForAllHosts(this)" data-toggle="tooltip" title="Refresh All Hosts" style="display: none; float: right"><span class="glyphicon glyphicon-refresh"></span>Refresh all</a><br>
