...
Manifestloadertool[4]="* The tool can be installed either on the same server as the WLM portal or on system that is on the same network as the Cloud Integrity Technology database.";
