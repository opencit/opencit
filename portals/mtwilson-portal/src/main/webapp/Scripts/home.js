...
function getAssetTagPage() {
    ...
    $('#AssetTagPage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#tags" + '" width="100%" height="1000" > </iframe>');
...
function getAssetSelectionPage() {
	$('#mainContainer').html('<div id="AssetSelectionPage"></div>');
        $('#AssetSelectionPage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#selections" + '" width="100%" height="1000" > </iframe>');

}

function getAssetCertificatePage() {
	$('#mainContainer').html('<div id="AssetCertificatePage"></div>');
        $('#AssetCertificatePage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#certificates" + '" width="100%" height="2000" > </iframe>');
...
function getAssetSettingsPage() {
	$('#mainContainer').html('<div id="AssetSettingsPage"></div>');
        $('#AssetSettingsPage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#configure" + '" width="100%" height="1500" > </iframe>');
...
function getAssetLogPage() {
	$('#mainContainer').html('<div id="AssetLogPage"></div>');
        $('#AssetLogPage').html('<iframe scrolling="no" frameborder="0" src="' + assetTagUrl + "/#log" + '" width="900" height="900" > </iframe>');
}
