...
(function (factory) {
    ...
    var defineGetAndSet = function (obj, propName, getter, setter) {
        try {
            ...
            try{
                ...
                throw new Error("watchJS error: browser not supported: "+error+" and: "+error2);
            }
        }
    };
    ...
    var loop = function(){
        ...
        for(var i in lengthsubjects){
			...
			if( subj.obj == undefined ) { return; } // jonathan added this guard 2013-08-10 // log.debug("subj = "+subj+" | prop = "+subj.prop+" | actual = "+subj.actual+" | obj = "+subj.obj);
