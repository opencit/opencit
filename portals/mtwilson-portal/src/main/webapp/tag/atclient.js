...
//VIEWS = parameters.views || {};
    ...
    ajax.resources.unfiltered_tags = {uri: '/tags', datapath: 'unfiltered_tags', idkey: 'uuid'}; // configurations can also use idkey:'oid' and idkey:'name' 
    ...
    ajax.resources.unfiltered_sels = {uri: '/selections', datapath: 'unfiltered_sels', idkey: 'uuid'}; // selections can also use idkey:'name'
...
//        }
    ...
    mtwilson.atag.findTagByUuid = function(uuid) {
        ...
        for (i = data.unfiltered_tags.length - 1; i >= 0; i--) {
            if (('uuid' in data.unfiltered_tags[i]) && data.unfiltered_tags[i].uuid == uuid) {
