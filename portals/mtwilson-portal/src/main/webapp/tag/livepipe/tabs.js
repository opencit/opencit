...
Control.Tabs = Class.create({
    initialize: function(tab_list_container,options){
        ...
        this.containers.values().each(function(el) { if( (typeof el != "string") && ("hide" in el) ) { Element.hide(el); } }); // added guard to make sure it's an html element before we try to hide it; someone may have added functions to Object.prototype which affects html elements too 2013-08-12
