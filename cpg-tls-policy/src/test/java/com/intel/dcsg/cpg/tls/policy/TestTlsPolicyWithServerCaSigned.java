...
//        createSelfSigned(caKeystorePath);
    ...
    public void testTrustKnownCertificateClient() throws Exception {
        ApacheTlsPolicy tlsPolicyTrustKnownCertificate = new TrustKnownCertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { tlsCert }));
    ...
    public void testTrustUnknownCertificateClient() throws Exception {
        ApacheTlsPolicy tlsPolicyTrustKnownCertificate = new TrustKnownCertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] {  }));
        HttpClient httpClient = httpClientFactoryCreateSslClientWithPolicy(tlsPolicyTrustKnownCertificate); //new DefaultHttpClient();
...
//    @Test
    public void testTrustUnnownCertificateClientWithDelegate() throws Exception {
        ...
        ApacheTlsPolicy tlsPolicyTrustKnownCertificate = new TrustKnownCertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { }), new ConsoleTrustDelegate(repository));
        HttpClient httpClient = httpClientFactoryCreateSslClientWithPolicy(tlsPolicyTrustKnownCertificate); //new DefaultHttpClient();
    ...
    public void testTrustCaCertificateClient() throws Exception {
        ApacheTlsPolicy tlsPolicyTrustCaAndVerifyHostname = new TrustKnownCertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { caCert }));
    ...
    public void testTrustCaCertificateClientWithKnownCertPolicy() throws Exception {
        ApacheTlsPolicy tlsPolicyTrustCaAndVerifyHostname = new TrustKnownCertificateTlsPolicy(new ArrayCertificateRepository(new X509Certificate[] { tlsCert }));
        HttpClient httpClient = httpClientFactoryCreateSslClientWithPolicy(tlsPolicyTrustCaAndVerifyHostname); //new DefaultHttpClient();
