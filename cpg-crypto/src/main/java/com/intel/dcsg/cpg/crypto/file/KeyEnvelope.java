...
-----END RSA PRIVATE KEY-----
    ...
    protected String toPem(String pemContentType) {
        HashMap<String,String> headers = new HashMap<String,String>(this.otherHeaders); // start with the optional "other headers" set and override using built-in values
