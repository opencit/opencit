...
(cd database/mysql && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"database/mysql\" folder" >&2; exit 3; fi
(cd database/postgresql && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"database/postgresql\" folder" >&2; exit 3; fi
...
(cd features/mtwilson-export-data-bundle && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"features/mtwilson-export-data-bundle\" folder" >&2; exit 3; fi
(cd features/mtwilson-localization-es && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"features/mtwilson-localization-es\" folder" >&2; exit 3; fi
...
(cd trust-agent/mtwilson-trustagent && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"trust-agent/mtwilson-trustagent\" folder" >&2; exit 3; fi
...
(cd installers/mtwilson-client-java6 && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"installers/mtwilson-client-java6\" folder" >&2; exit 3; fi
(cd installers/mtwilson-client-java7 && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"installers/mtwilson-client-java7\" folder" >&2; exit 3; fi
(cd packages && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"packages\" folder" >&2; exit 3; fi
(cd packages/mtwilson-server-zip && $changeVersionCommand)
if [ $? -ne 0 ]; then echo "Failed to change maven version on \"packages/mtwilson-server-zip\" folder" >&2; exit 3; fi
