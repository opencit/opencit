...
//            keyStore = KeyStoreUtil.getKeyStore(SAMLSignature.class.getResourceAsStream(config.getString ("keystore")),config.getString ("storepass"));
            try {
            	keyStore = getKeyStore(keystoreInputStream,config.getString("saml.keystore.password",System.getenv("SAMLPASSWORD")));
            }
            finally {
            ...
            KeyStore.PrivateKeyEntry entry = (KeyStore.PrivateKeyEntry)
                keyStore.getEntry (config.getString ("saml.key.alias"), 
                    new KeyStore.PasswordProtection 
                        (config.getString ("saml.key.password", System.getenv("SAMLPASSWORD")).toCharArray ()));
