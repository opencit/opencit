...
////        ds = Derby.getDataSource();
////        DBI dbi = new DBI(ds);
////        TagDAO attributeDao = dbi.open(TagDAO.class);
////        TagValueDAO dao = dbi.open(TagValueDAO.class);
//        TagDAO attributeDao = Derby.attributeDao();
//        TagValueDAO dao = Derby.attributeValueDao();
//
//        UUID tagUuid = new UUID();
//        long tagId = attributeDao.insert(tagUuid, "first name", "1.1.1.1");
//        
