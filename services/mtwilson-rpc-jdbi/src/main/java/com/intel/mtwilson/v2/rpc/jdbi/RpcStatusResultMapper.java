 ...
 * @author jbuhacoff
 */
public class RpcStatusResultMapper implements ResultSetMapper<RpcStatus> {

    @Override
    public RpcStatus map(int i, ResultSet rs, StatementContext sc) throws SQLException {
