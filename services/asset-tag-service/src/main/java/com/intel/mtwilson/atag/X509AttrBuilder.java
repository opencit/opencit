 ...
 * creation of X509 Attribute Certificates.  Certificates created by this builder
 * do NOT have a public key. They only have attributes about the subject/holder.
 * 
 * NOTE: this is different than X509 Public Key Certificates which can be built
 * using cpg-crypto X509AttrBuilder.  
 * 
...
public class X509AttrBuilder extends BuilderModel {
     ...
     * X509AttrBuilder x509 = X509AttrBuilder.factory().subjectName(...).alternativeName(...);
     ...
     * @return 
     */
    public static X509AttrBuilder factory() { return new X509AttrBuilder(); } 
