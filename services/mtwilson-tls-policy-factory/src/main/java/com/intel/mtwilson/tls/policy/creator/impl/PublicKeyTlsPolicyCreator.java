...
public class PublicKeyTlsPolicyCreator implements TlsPolicyCreator {
     ...
     */
    private PublicKey decodePublicKey(String publicKeyBase64) throws CryptographyException {
        ...
        try {
            X509Certificate certificate = X509Util.decodeDerCertificate(Base64.decodeBase64(publicKeyBase64));
