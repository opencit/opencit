 ...
 * @author jbuhacoff
 */
public class PcrModuleManifestMissingExpectedEntries extends Fault {
    private PcrIndex pcrIndex;
    private Set<Measurement> missingEntries;
    public PcrModuleManifestMissingExpectedEntries(PcrIndex pcrIndex, Set<Measurement> missingEntries) {
