...
public class HostBO extends BaseBO {
         ...
         * Author: Sudhir
         *
         * Registers the host using the additional details like which MLE to use
         * etc for registration.
         *
         * @param hostConfigObj : Host Configuration object having the details
         * of the host to be registered along with the details of the MLE that
         * needs to be used for registration.
         *
        ...
        /**
         * Updates the host with the new MLE information that the user has
         * chosen.
         *
         * @param apiClientObj
         * @param tblHostObj
         ...
         *
         * @param gkvHost: User need to provide just the Host Name and vCenter
         * Connection string in case of VMware hosts. For Open Source
         * hypervisors, user need to provide the IP Address and port number.
         ...
         * Author: Sudhir
         *
         * This function using the white list configuration settings including
         * pcr details, whether the whitelist is for an individual host/for OEM
         * specific host/global white list, etc, configures the DB with the
         * whitelist from the specified good known host.
         *
         * @param hostConfigObj : White List configuration object having all the
         * details.
...
//                    attestationReport = vmmHelperObj.getHostAttestationReport(gkvHost, reqdManifestList);
         ...
         * Author: Sudhir
         *
         * Verifies if all the MLE configuration exists for the host to be
         * registered.
         *
         * @param hostObj: Host object having the details of the host to be
         * registered.
         * @param wlTarget: Indicates whether the host to be registered has to
         * use global white list or OEM specific white list.
         * @return : True if all the backend configuration exists, if not throws
         * an exception.
         */
         ...
         * Author: Sudhir
         *
         * Configures the BIOS MLE using the Good known host specified in the
         * WhiteListConfiguration object.
         *
         * @param apiClientObj : ApiClient object for making the ApiClient
         * calls.
         * @param hostConfigObj : WhiteListConfiguration object having the
         * details of the Host and how the white list should be configured.
         * @return : A boolean indicating if the BIOS MLE was created or it
         * already existed.
         */
         ...
         * Author: Sudhir
         *
         * Configures the Hypervisor(VMM) MLE using the Good known host
         * specified in the WhiteListConfiguration object.
         *
         * @param apiClientObj : ApiClient object for making the ApiClient
         * calls.
         * @param hostConfigObj : WhiteListConfiguration object having the
         * details of the Host and how the white list should be configured.
         * @return : A boolean indicating if the VMM MLE was created or it
         * already existed.
         */
         ...
         * @param hostObj : TxtHostRecord object having the details of the MLE
         * to be deleted.
         * @param isBIOSMLE : This flag will be set to true if the MLE being
         * deleted is BIOS. For VMM MLEs it would be FALSE
         */
         ...
         * Author : Sudhir
         *
         * Uploads the attestation report (event info and pcr info) into the
         * White List Database for the specified good known host.
         *
         * @param hostConfigObj : WhiteList Configuration object having the
         * details of the host, which would be used as the good known host
         * @param attestationReport : XML report having all the details of the
         * good known measurements that need to be uploaded to the database.
