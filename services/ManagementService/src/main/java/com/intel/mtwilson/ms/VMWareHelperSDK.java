...
import com.intel.mtwilson.ms.HostInfoInterface;
...
//            private static Logger log = LoggerFactory.getLogger(VMWareHelperSDK.class);
...
//        protected Object getMORProperty(ManagedObjectReference moRef, String propertyName) 
...
//				//log.log(Level.INFO, "getHostObject - comparing hostNameFromVC {0} requested hostName {1}", new Object[] { hostNameFromVC, hostName });
//				if (hostNameFromVC.equals(hostName)) {
//				//	log.info(String.format(	"Found Managed Object Reference for host %s ",	hostName));
//					return hostObj;
//				}
//			}
//		}
...
//        try
//        {
//            //log.log(Level.SEVERE, "Retrieving details for : " + hostObj.HostName + ":" + hostObj.AddOn_Connection_String);
//            
...
//            } catch (Exception ex) {
//                
//                //log.log(Level.SEVERE, "Unexpected errror while getting the MOR object for : " + hostObj.HostName + ex.getMessage());
//                throw ex;
//            }
//            
