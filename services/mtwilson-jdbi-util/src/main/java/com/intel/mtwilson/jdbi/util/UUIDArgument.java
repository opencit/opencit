...
/**
 * XXX TODO: this class should be moved to cpg-io under a jdbi package (where
 * jdbi has a provided/optional scope) or to a new cpg-jdbi module if it looks
 * like jdbi is going to be a mainstay of the quick prototypes.
 *
