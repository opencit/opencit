...
public class TlsPolicyDescriptor {
    private String name; // insecure, TRUST_FIRST_CERTIFICATE, public-key, public-key-digest, certificate, certificate-digest
    ...
    private Map<String,String> meta; // digestAlgorithm (MD5, SHA-1, SHA-256, etc), encoding (base64 or hex)
