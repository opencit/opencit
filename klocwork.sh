...
buildProject() {
  kwbuildproject --url "${klocworkServerUrl}/${klocworkProject}" --tables-directory "${tablesDirectory}" --force "${buildSpecsDirectory}/mtwilson.out" "${buildSpecsDirectory}/aikqverify.out" "${buildSpecsDirectory}/aikqverify_services.out" "${buildSpecsDirectory}/hex2bin_rhel.out" "${buildSpecsDirectory}/aikquote_rhel.out" "${buildSpecsDirectory}/hex2bin_ubuntu.out" "${buildSpecsDirectory}/aikquote_ubuntu.out" "${buildSpecsDirectory}/niarl_plain.out" "${buildSpecsDirectory}/niarl_sha1.out" "${buildSpecsDirectory}/hex2bin.out" "${buildSpecsDirectory}/tpm_cit_commands.out"
}
