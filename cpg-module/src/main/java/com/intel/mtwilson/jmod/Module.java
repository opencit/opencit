...
public class Module {
    ...
    public static final String JMOD_COMPONENTS = "Jmod-Components";
    public static final String JMOD_COMPONENT_SEARCH = "Jmod-Component-Search";
    ...
    public String[] getComponentNames() {
        ...
        String componentNames = manifest.getMainAttributes().getValue(JMOD_COMPONENTS);
