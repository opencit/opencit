 ...
 * @since 1.2
 */
public class VmMeasurement extends ObjectModel {

    private final Sha256Digest digest;
    private final String label;
    private final HashMap<String,String> info = new HashMap<>();
    
    public VmMeasurement(Sha256Digest digest, String label) {
        this.digest = digest;
        this.label = label;
    }

    @JsonCreator
    public VmMeasurement(@JsonProperty("value") Sha256Digest digest, @JsonProperty("label") String label, @JsonProperty("info") Map<String,String> info) {
        this.digest = digest;
        this.label = label;
        if( info != null ) {
    ...
    public Sha256Digest getValue() { return digest; }
...
//    @JsonValue
    ...
    public boolean equals(Object obj) {
        ...
        final VmMeasurement other = (VmMeasurement) obj;
    ...
    protected void validate() {
        ...
        else if (!Sha256Digest.isValid(digest.toByteArray())) { fault("Invalid measurement value"); }
