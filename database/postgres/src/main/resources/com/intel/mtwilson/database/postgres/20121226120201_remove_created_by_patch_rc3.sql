...
ALTER TABLE mw_pcr_manifest DROP CONSTRAINT PCR_Created_By;
ALTER TABLE mw_pcr_manifest DROP COLUMN Created_By;

ALTER TABLE mw_pcr_manifest DROP CONSTRAINT PCR_Last_Updated_By;
ALTER TABLE mw_pcr_manifest DROP COLUMN Updated_By;
...
ALTER TABLE mw_module_manifest DROP CONSTRAINT Module_Created_By;
ALTER TABLE mw_module_manifest DROP COLUMN Created_By;

ALTER TABLE mw_module_manifest DROP CONSTRAINT Module_Last_Updated_By;
ALTER TABLE mw_module_manifest DROP COLUMN Updated_By;
