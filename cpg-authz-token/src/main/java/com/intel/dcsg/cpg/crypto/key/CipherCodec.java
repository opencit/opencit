...
public abstract class CipherCodec<T> {
    ...
    private transient EncryptionKeySource encryptionKeySource;
    private transient Protection protection;
//    private transient Cipher cipher;
//    private transient MessageDigest md;
    private transient RandomSource random;
    private transient HashMap<String,Cipher> ciphers = new HashMap<String,Cipher>();
    private transient HashMap<String,MessageDigest> digests = new HashMap<String,MessageDigest>();
    ...
    public final synchronized byte[] encrypt(T object) throws CryptographyException {
...
//                if( plaintext.header != null ) { md.update(plaintext.header); }
            ...
            byte[] plaintextBytes = formatPlaintext(plaintext, object);
     ...
     */
    public final synchronized T decrypt(byte[] ciphertext) throws CryptographyException, KeyNotFoundException {
        try {
