...
appendToUserProfileFile "export PATH=$TRUSTAGENT_BIN:\$PATH"
appendToUserProfileFile "export TRUSTAGENT_HOME=$TRUSTAGENT_HOME"
...
# took out tpm-tools, prereq for the TA is to have patched tpm-tools, on rhel 7.1 it installs unpatched tools over the patched ones, messes up TA installation
APPLICATION_YUM_PACKAGES="openssl  trousers trousers-devel make gcc unzip authbind"
