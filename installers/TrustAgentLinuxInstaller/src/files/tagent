...
function read_local_config() {
    ...
    javaVMArgs="-Dfs.root=/opt/trustagent -Dfs.conf=/opt/trustagent/configuration -Djavax.net.ssl.trustStore=$intel_conf_dir/trustagent.jks -Djavax.net.ssl.keyStore=$intel_conf_dir/trustagent.jks -Djavax.net.ssl.keyStorePassword=env:TaKeyStorePassword -Dapp.path=$package_dir -Ddebug=true"  # arguments for Java launcher
