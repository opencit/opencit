...
TODO: instead of installing a management-service.properties.new in case of an
upgrade,  compare the properties in existing file to new file and if there are 
new properties add them to the existing file as comments, and if there are any
deprecated properties add comments in front of them in the existing file.
