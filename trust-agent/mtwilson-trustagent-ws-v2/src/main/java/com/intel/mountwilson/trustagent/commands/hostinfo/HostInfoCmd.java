...
public class HostInfoCmd implements ICommand {
    ...
    private void getOsAndVersion() throws TAException, IOException {
        CommandResult commandResult = CommandUtil.runCommand("tagent lsb_release -a");
    ...
    private void getBiosAndVersion() throws TAException, IOException {
        CommandResult result = CommandUtil.runCommand("tagent dmidecode -s bios-vendor");
        ...
        CommandResult result2 = CommandUtil.runCommand("tagent dmidecode -s bios-version");
    ...
    private void getVmmAndVersion() throws TAException, IOException {
        ...
        CommandResult commandResult = CommandUtil.runCommand("tagent virsh version");
        if (commandResult != null && commandResult.getStdout() != null) {
            String[] result = commandResult.getStdout().split("\n");
     ...
     */
       private void getProcessorInfo() throws TAException, IOException {
            ...
            CommandResult commandResult = CommandUtil.runCommand("tagent dmidecode --type processor");
            if (commandResult != null && commandResult.getStdout() != null) {
                String[] result = commandResult.getStdout().split("\n");
    ...
    public void getHostUUID() throws TAException, IOException {
        CommandResult result = CommandUtil.runCommand("tagent dmidecode -s system-uuid");
