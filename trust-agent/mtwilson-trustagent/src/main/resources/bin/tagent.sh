...
TRUSTAGENT_SETUP_TASKS="create-keystore-password create-tls-keypair create-admin-user $TRUSTAGENT_TPM_TASKS $TRUSTAGENT_AUTHORIZE_TASKS download-mtwilson-saml-certificate"
